...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private static boolean mIsSysApp = true; //by linyu.li for disableAllapp
    private boolean mIsApp ; //by linyu.li for disableAllapp
    ...
    //by linyu.li for disallapp 20161112 start
    ...
    private boolean isMainapp(Object info) {
        if(info instanceof ShortcutInfo){
        	ShortcutInfo appInfo = (ShortcutInfo) info;
        	return appInfo.intent.getAction()==Intent.ACTION_MAIN;
        }
    	return false;
    }
    //by linyu.li for disallapp 20161112 start
    ...
    public boolean acceptDrop(DragObject d) {
    	//by linyu.li for disableAllapp start
    	if(mIsApp){
    	...
    	return true;
      //by linyu.li for disableAllapp end
    }
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        //by linyu.li for disableAllapp
        boolean useUninstallLabel =  isShortcut(source, info)&&isMainapp(info);
        ...
        //by linyu.li for disableAllapp start
         if(info instanceof ShortcutInfo){
         	try{
	        	ShortcutInfo appInfo = (ShortcutInfo) info;
	        	if(appInfo.intent.getAction()==Intent.ACTION_MAIN){
    ...
    //by linyu.li for disableAllapp start
      private boolean isUninstallFromDisableAllApp(DragObject d) {    	  
        if (d.dragInfo instanceof LauncherAppWidgetInfo ||!mIsApp) {           
            return false;
        }
        return true;
    }
    ...
    private void completeDrop(DragObject d) {
        ...
        if (isAllAppsApplication(d.dragSource, item)) {
            ...
            mLauncher.startApplicationUninstallActivity(appInfo.componentName, appInfo.flags,
                    appInfo.user);
        } else if (isUninstallFromDisableAllApp(d)) {//by linyu.li for disableAllapp
    ...
    public void onDrop(DragObject d) {
        ...
        if(!mIsApp){
        	animateToTrashAndCompleteDrop(d);//by linyu.li for disableAllapp start
        }
    }
    ...
    public void onFlingToDelete(final DragObject d, int x, int y, PointF vel) {
        ...
        Runnable onAnimationEndRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (!isAllApps) {
                    mLauncher.exitSpringLoadedDragMode();
                 //   completeDrop(d);// by linyu.li for disallapp 20161112
                }
